...
- Are there more different species in amended or unamended soils? ((betta)[] might help)
...
*Here's a not-so-fun fact, by the way -- "intuitive" methods that log-transforms pseudocount-modified data are guaranteed to converge to the wrong answer ("inconsistency"). It may not be very wrong in practice, but it'll still be wrong. Maybe that's it's own blog post for another day.*
...
Wrap-up: I really believe that radEmu is a great way to do differential abundance, and because of that, I want you to use it. So, please check it out, and let us know your feedback. If there's something we can do to convince you to use it, tell us, please! 
