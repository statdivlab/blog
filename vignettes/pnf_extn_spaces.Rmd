...
vignette: >
  %\VignetteIndexEntry{PNF: Extension Spaces}
...
![The Prevotella phylogenomic tree with splits colored by bootstrap support (left) and gene tree support (right). We observe zero gene tree support for several deep splits, but note the high bootstrap support for these splits.](images/support.png)
